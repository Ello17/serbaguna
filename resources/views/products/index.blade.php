                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="gambar" name="gambar[]" accept="image/*"
                                required multiple>
                            <div class="form-text">Format file harus gambar (.jpg, .jpeg .png) dan nama file sesuai dengan
                                nama yang ada pada nama di data import</div>
                        </div>
                        <div class="alert alert-info">
                            <strong>Petunjuk:</strong> Unduh template <a
                                href="{{ asset('templates/product_template.xlsx') }}" download>di sini</a> untuk memastikan
                            format yang benar.
                        </div>
                    </div>
