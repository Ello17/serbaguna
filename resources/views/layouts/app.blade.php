            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="{{ route('finance.index') }}"
                        class="nav-link text-white {{ request()->routeIs('finance.*') ? 'active' : '' }}">
                        <i class="bi bi-cash-stack me-2"></i> Keuangan
                    </a>
                </li>
                <li>
                    <a href="{{ route('notifications.index') }}"
                        class="nav-link text-white {{ request()->routeIs('notifications.*') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('calculator.index') }}"
                        class="nav-link text-white {{ request()->routeIs('calculator.*') ? 'active' : '' }}">
